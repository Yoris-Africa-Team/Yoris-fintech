...
const CatalogueReviews = () => {
  return (
    <div className="w-full max-w-full mx-auto  text-white p-6 rounded-lg shadow-lg">
      ...
      {/*Write a Review  */}
      <div className="flex items-center w-full mx-auto max-w-[90%] mt-12 bg-inherit  text-gray-300 border border-[#C3AD60] rounded-full px-4 py-2">
        {/* Plus Icon */}
        <div className="p-2 bg-[#1a1916] border border-[#897943] rounded-full">
          <Plus className="w-5 h-5 text-[#897943]" />
        </div>
        ...
        <input
          ...
          className="flex-grow bg-transparent w-full outline-none px-4 text-sm"
        />

        {/* Arrow Icon */}
        <ArrowRight className="w-5 h-5 text-[#897943]" />
      </div>
    </div>
  );
};
