...
export default function Header() {
  ...
  return (
    <header className="w-full fixed top-0 left-0 right-0 bg-[#100F0DB2] bg-opacity-70 z-50 px-8 py-4">
      ...
      {isOpen && (
        <motion.div 
          ...
          className="md:hidden absolute top-full left-0 w-full bg-[#100F0DB2] backdrop-blur-md text-left py-5"
        >
