...
function handleSubmit(e: any){
  ...
  return (
   ...
   <div className="flex justify-start items-center ">
    ...
    <IoIosArrowBack className="text-[#C3AD60] cursor-pointer flex-shrink-0 " 
     ...
     />
     <h2 className="text-lg text-white font-medium flex-grow justify-center flex">Withdraw</h2>
    </div>
  ...
  <form className='flex flex-col max-w-[400px] w-full mx-auto gap-4'
  ...
  >
   ...
   <button className='flex bg-[#C3AD60] text-black rounded-md items-center justify-center py-4 px-5 font-bold gap-2' 
   ...
   <div className='flex justify-start mt-4 text-[10px] font-semibold text-white'>Minimum of N100 to complete withdrawal*</div>
  </form>
